...
import com.example.fileService.entity.UserDetailsImpl;
import com.example.fileService.entity.UserEntity;
import com.example.fileService.exception.AuthServerException;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    private boolean validateTokenWithAuthServer(String token) {
        ...
        ResponseEntity<UserEntity> responseEntity = null;
